...
public class FindDetailPOJO {
    ...
    public String getDutyHano() {
        return dutyHano;
    }

    public void setDutyHano(String dutyHano) {
        this.dutyHano = dutyHano;
    }
    ...
    public void setDutyimg(String dutyimg) {
